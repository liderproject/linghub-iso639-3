...
fs.writeFile('babelnet_all_predictions_levenshtein.json', '')
parseLanguageFile()
...
function language(str, done) {
    ...
    rd.on('line', function(line) {
        ...
        var distArray = levenshteinenator.levenshteinenator(str, lemma);
    ...
    rd.on('close', function(line) {
        fs.appendFile('babelnet_all_predictions_levenshtein.json', JSON.stringify(highest) + '\n', function(err) {
